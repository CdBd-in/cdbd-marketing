...
- 04 해법 본문/05 정리 제목 반영 · [[CdBd 매거진/04. 콘텐츠 기획 가이드.md|콘텐츠 기획]] §4에 카드명 정확성 규칙 추가
...
- **dim 그라데이션 표준**: 세로 그라데이션 + **paint opacity 0.5**(부드럽게) — 앞으로 body 공통 ([[CdBd 매거진/02. 본문(Body).md|규칙]])
