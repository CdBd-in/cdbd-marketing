...
#### 3.2.4. 아직 캡처 안 한 화면 (다음 세션 우선순위) 📸

| 화면 | 캡처 방법 | 우선순위 |
|------|----------|---------|
| **상단 4개 아이콘 정확한 명칭** | hover tooltip 또는 클릭 후 패널 캡처 | P1 |
| **카드 종류 전체** (이미지/버튼 외 더 있는지) | "카드 추가하기" 클릭 후 모달 캡처 | P1 |
| **AI 자동 디자인** | 전구 아이콘 클릭 후 패널 | P1 |
| **게시 후 관리 대시보드** | 게시하기 후 redirect 또는 통계보기 | P2 |
| **팀 공유 / 멤버 권한** | admin 또는 settings 페이지 | P2 |
| **개인화 QR 생성** | 카드 메뉴 ⋮ → QR? 또는 admin | P2 |
| **폼 응답 수집** | 폼 카드 추가 후 응답 페이지 | P3 |

→ `step2-explore-actions.mjs` 등 추가 스크립트로 확장 예정
...
**Status:** 🌳 Maturing — § 1 다층 분석 / § 2 17/17 slug ✅ / § 3 viewer 18개 + 에디터 진짜 명칭 다수 확보 / Playwright 자동 캡처 인프라 ✅
