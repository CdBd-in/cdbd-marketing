...
```bash
# 한 번 실행으로 대시보드 + 에디터 한 페이지 캡처 + UI 텍스트 추출
cd scripts/cdbd-capture
node step1-editor-discovery.mjs

# 결과:
# - screenshots/dashboard-full.png    (대시보드 전체)
# - screenshots/dashboard-viewport.png
# - screenshots/editor-full.png       (에디터 전체)
# - screenshots/editor-viewport.png
# - screenshots/ui-texts.json         (모든 버튼/링크/헤딩 텍스트)
```
