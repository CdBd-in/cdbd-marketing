...
> - **2·3·4번 (`lookbook`·`newarrival`·`online_lookbook`)** → **멀티페이지 목업** (`4639:451`) 사용 — 캡처는 중앙 #FFFFFF 영역(`4639:456`)에 fill
...
| 2026-05-26 | § 2.2 카탈로그 **목업 종류** 명시 — `oak_table`=원페이지 / `lookbook`·`newarrival`·`online_lookbook`=**멀티페이지 목업** (`4639:451`의 #FFFFFF 영역에 캡처 fill) |
