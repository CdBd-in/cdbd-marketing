...
> **역할**: [[1-3-1. 비주얼 규칙]]이 정의한 비주얼 슬롯(주/보조)에 **실제로 넣을 자산**을 결정. (규칙=어떻게 / 비주얼 아카이브=무엇을)
> **사용처**: [[1-4. 레퍼런스 & 프롬프트]]의 프롬프트 템플릿과 함께 컨텍스트로 전달.
...
| 3 | `newarrival` | **The ELXE Lab — BEYOND LIQUID** / 신제품 소개부터 구매 유도, 매장 안내까지 하나의 흐름으로 | **멀티페이지** ⭐ | #카탈로그 #뷰티 #신제품 #구매유도 #신상 | https://www.cdbd.in/templates/catalog/newarrival/viewer | ([[1-2. 템플릿]] 예시로 사용) |
