// invitation/gala-rsvp viewer — 430px viewport, ar 0.4643 매칭 캡처
import { chromium } from 'playwright';
import { mkdirSync, existsSync, writeFileSync } from 'fs';
import { resolve, join } from 'path';

const VIEWER_URL = process.argv[2] || 'https://www.cdbd.in/templates/invitation/gala-rsvp/viewer';
const PREFIX = process.argv[3] || 'gala430';
const VIEWPORT_W = 430;
const VIEWPORT_H = Math.round(430 / 0.4643); // 926

const OUT_DIR = resolve('./screenshots/usecase05');
